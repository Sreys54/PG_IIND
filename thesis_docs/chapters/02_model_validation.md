...
| Connector and rated power | `ev.max_ac_charge_power/max_dc_charge_power: 50 kW`, CCS Combo 2 implied | No — no observed 8-port Enel X site has 50 kW DC | Same Enel X inventory: the two ~8-port sites are AC-only (Salitre: 8x Type2 AC 43kW; CC Retiro: 8x AC 7.2kW); ~~Res. 40223/2021 sets the DC floor this config targets~~ **[CORRECTED 2026-09-08, Week 5 Part A: wrong. Res. 40223/2021 Art. 4's minimum is Tipo 1 AC / CCS Combo 1 DC — "CCS Combo 2" is not in the resolution's text. The config's CCS2 assumption is justified by market practice (Enel Colombia's own network uses CCS1/CCS2/GBT), not by this resolution; a DC station equipped only with CCS2 would not itself satisfy Art. 4's minimum, which requires Combo 1 specifically. See `01_baseline.md` §1.1(a)'s full 2026-09-08 correction.]** | Overload dynamics in Week 1 (AFAP 0.132 kWh, RR 0.0 kWh) are driven by a charging capability that does not exist yet at any single observed 8-port site | Label: **simplification / declared limitation**. Documented in `01_baseline.md` §1.1(a) as a near-term upgrade scenario justified by market practice, not current hardware and not a regulatory floor (corrected 2026-09-08). |
